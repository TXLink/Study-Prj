...
namespace WebApplication1.bootstrapTree
{
    /// <summary>
    /// main 的摘要说明
    /// </summary>
    public class main : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            List<BootstrapTree> allBoottree = new List<bootstrapTree.BootstrapTree>();
            //获取所有节点的数据
            ...
            context.Response.Write(js.Serialize(bootStarp));
        }
        ...
        {
            List<BootstrapTree> lst = new List<bootstrapTree.BootstrapTree>();
            BootstrapTree mBoot = new bootstrapTree.BootstrapTree();
            ...
            mBoot = new bootstrapTree.BootstrapTree();
            mBoot.ID = 2;
            mBoot.ParentID = 0;
            mBoot.text = "第二级别";
            mBoot.Level = 1;
